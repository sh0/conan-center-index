...
class GStreamerConan(ConanFile):
    ...
    def source(self):
        ...
        tools.replace_in_file(os.path.join(self._source_subfolder, "meson.build"), "'--quiet'", "'-v'")
    ...
    def _configure_meson(self):
        ...
        meson.options["introspection"] = "enabled" if self.options.introspection else "disabled"
